...
public class Emoji {
    ...
    public static String convertEmoji2Img(String html, Address[] fromAddrs) {
        ...
        for (int i = 0; i < html.length(); i = html.offsetByCodePoints(i, 1)) {
            ...
            if (emoji != null)
                buff.append("<img src=\"file:///android_asset/mobylet-emoticons/")
                        .append(emoji)
                        .append(".gif\" alt=\"")
                        .append(emoji)
                        .append("\" />");
    ...
    // return emoji code String or null
    private static String getEmojiCodePoint(Carrier carrier, int codePoint) {
        switch (carrier) {
            case DOCOMO:
                return getEmojiForCodePointDocomo(codePoint);
            case SOFTBANK:
                return getEmojiForCodePointSoftBank(codePoint);
            case KDDI:
                return getEmojiForCodePointKDDI(codePoint);
            default:
                return getEmojiForCodePointDocomo(codePoint);
        }
    }
